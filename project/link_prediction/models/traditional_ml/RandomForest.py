...
class RandomForestModel(LinkPredictionModel):
    def __init__(self, **kwargs):
        print("Initialized Random Forest Link Prediction Model.")
    ...
    def train(self, train_data: Data, val_data: Data = None):
        ...
        print("Fitting the RandomForestClassifier...")
    ...
    def predict_edges(self, graph_data: Data, edges_to_predict: torch.Tensor) -> torch.Tensor:
        ...
        print(f"Predicting on {edges_to_predict.size(1)} edges using Random Forest...")
